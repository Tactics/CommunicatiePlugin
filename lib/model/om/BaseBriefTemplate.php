...
abstract class BaseBriefTemplate extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_publiciteit field.
	 * @var        boolean
	 */
	protected $is_publiciteit = false;
	...
	/**
	 * The value for the pdf_template_id field.
	 * @var        int
	 */
	...
	/**
	 * The value for the afzender_id field.
	 * @var        int
	 */
	protected $afzender_id;
	...
	/**
	 * Collection to store aggregation of collBriefTemplatesRelatedByPdfTemplateId.
	 * @var        array
	 */
	protected $collBriefTemplatesRelatedByPdfTemplateId;

	/**
	 * The criteria used to select the current contents of collBriefTemplatesRelatedByPdfTemplateId.
	 * @var        Criteria
	 */
	...
	/**
	 * Collection to store aggregation of collActiviteitsRelatedByConfiguredBriefTemplateId.
	 * @var        array
	 */
	protected $collActiviteitsRelatedByConfiguredBriefTemplateId;

	/**
	 * The criteria used to select the current contents of collActiviteitsRelatedByConfiguredBriefTemplateId.
	 * @var        Criteria
	 */
	protected $lastActiviteitRelatedByConfiguredBriefTemplateIdCriteria = null;

	/**
	 * Collection to store aggregation of collActiviteitsRelatedByConfiguredPersoonBriefTemplateId.
	 * @var        array
	 */
	protected $collActiviteitsRelatedByConfiguredPersoonBriefTemplateId;

	/**
	 * The criteria used to select the current contents of collActiviteitsRelatedByConfiguredPersoonBriefTemplateId.
	 * @var        Criteria
	 */
	protected $lastActiviteitRelatedByConfiguredPersoonBriefTemplateIdCriteria = null;

	/**
	 * Collection to store aggregation of collActiviteitsRelatedByConfiguredOrganisatieBriefTemplateId.
	 * @var        array
	 */
	protected $collActiviteitsRelatedByConfiguredOrganisatieBriefTemplateId;

	/**
	 * The criteria used to select the current contents of collActiviteitsRelatedByConfiguredOrganisatieBriefTemplateId.
	 * @var        Criteria
	 */
	protected $lastActiviteitRelatedByConfiguredOrganisatieBriefTemplateIdCriteria = null;

	/**
	 * Collection to store aggregation of collDossierTypes.
	 * @var        array
	 */
	protected $collDossierTypes;

	/**
	 * The criteria used to select the current contents of collDossierTypes.
	 * @var        Criteria
	 */
	...
	/**
	 * Get the [is_publiciteit] column value.
	 * 
	 * @return     boolean
	 */
	public function getIsPubliciteit()
	{

		return $this->is_publiciteit;
	}
	...
	/**
	 * Get the [pdf_template_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [afzender_id] column value.
	 * 
	 * @return     int
	 */
	public function getAfzenderId()
	{

		return $this->afzender_id;
	}
	...
	/**
	 * Set the value of [is_publiciteit] column.
	 * 
	 * @param      boolean $v new value
	 * @return     void
	 */
	public function setIsPubliciteit($v)
	{

		if ($this->is_publiciteit !== $v || $v === false) {
			$this->is_publiciteit = $v;
			$this->modifiedColumns[] = BriefTemplatePeer::IS_PUBLICITEIT;
		}
	...
	/**
	 * Set the value of [pdf_template_id] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
	...
	/**
	 * Set the value of [afzender_id] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
	public function setAfzenderId($v)
	{
		...
		if ($this->afzender_id !== $v) {
			$this->afzender_id = $v;
			$this->modifiedColumns[] = BriefTemplatePeer::AFZENDER_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->is_publiciteit = $rs->getBoolean($startcol + 9);

			$this->systeemnaam = $rs->getString($startcol + 10);

			$this->systeemplaceholders = $rs->getString($startcol + 11);

			$this->gearchiveerd = $rs->getInt($startcol + 12);

			$this->pdf_template_id = $rs->getInt($startcol + 13);

			$this->afzender_id = $rs->getInt($startcol + 14);
			...
			return $startcol + 19; // 19 = BriefTemplatePeer::NUM_COLUMNS - BriefTemplatePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[9], $arr)) $this->setIsPubliciteit($arr[$keys[9]]);
		...
		if (array_key_exists($keys[14], $arr)) $this->setAfzenderId($arr[$keys[14]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BriefTemplatePeer::IS_PUBLICITEIT)) $criteria->add(BriefTemplatePeer::IS_PUBLICITEIT, $this->is_publiciteit);
		...
		if ($this->isColumnModified(BriefTemplatePeer::AFZENDER_ID)) $criteria->add(BriefTemplatePeer::AFZENDER_ID, $this->afzender_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsPubliciteit($this->is_publiciteit);
		...
		$copyObj->setAfzenderId($this->afzender_id);
	...
	public function getBriefTemplateRelatedByPdfTemplateId($con = null)
	{
		if ($this->aBriefTemplateRelatedByPdfTemplateId === null && ($this->pdf_template_id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = BriefTemplatePeer::retrieveByPK($this->pdf_template_id, $con);
			   $obj->addBriefTemplatesRelatedByPdfTemplateId($this);
			 */
		}
	 ...
	 * @throws     PropelException
	 */
	public function setPersoon($v)
	{


		if ($v === null) {
			$this->setAfzenderId(NULL);
		} else {
			$this->setAfzenderId($v->getId());
		}
	 ...
	 * @throws     PropelException
	 */
	public function getPersoon($con = null)
	{
		if ($this->aPersoon === null && ($this->afzender_id !== null)) {
			// include the related Peer class
			include_once 'lib/model/om/BasePersoonPeer.php';

			$this->aPersoon = PersoonPeer::retrieveByPK($this->afzender_id, $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = PersoonPeer::retrieveByPK($this->afzender_id, $con);
			   $obj->addPersoons($this);
			 */
		}
	...
	/**
	 * Temporary storage of collBriefTemplatesRelatedByPdfTemplateId to save a possible db hit in
	 ...
	 * been saved, it will retrieve related BriefTemplatesRelatedByPdfTemplateId from storage.
	...
	/**
	 * Returns the number of related BriefTemplatesRelatedByPdfTemplateId.
	 *
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with
	 * an identical criteria, it returns the collection.
	 * Otherwise if this BriefTemplate is new, it will return
	 * an empty collection; or if this BriefTemplate has previously
	 * been saved, it will retrieve related BriefTemplatesRelatedByPdfTemplateId from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in BriefTemplate.
	 */
	 ...
	 * actually need in BriefTemplate.
	 */
	public function getBriefTemplatesRelatedByPdfTemplateIdJoinPersoon($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'plugins/ttCommunicatiePlugin/lib/model/om/BaseBriefTemplatePeer.php';
		if ($criteria === null) {
		...
		if ($this->collBriefTemplatesRelatedByPdfTemplateId === null) {
			if ($this->isNew()) {
				...
				$this->collBriefTemplatesRelatedByPdfTemplateId = BriefTemplatePeer::doSelectJoinPersoon($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Temporary storage of collActiviteitsRelatedByConfiguredBriefTemplateId to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	 ...
	 * an identical criteria, it returns the collection.
	 * Otherwise if this BriefTemplate has previously
	 * been saved, it will retrieve related ActiviteitsRelatedByConfiguredBriefTemplateId from storage.
	 * If this BriefTemplate is new, it will return
	 * an empty collection or the current collection, the criteria
	 * is ignored on a new object.
	 *
	...
	/**
	 * Returns the number of related ActiviteitsRelatedByConfiguredBriefTemplateId.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      Connection $con
	...
	/**
	 * Method called to associate a Activiteit object to this object
	 * through the Activiteit foreign key attribute
	 *
	 * @param      Activiteit $l Activiteit
	 * @return     void
	 * @throws     PropelException
	 */
	...
	/**
	 * Temporary storage of collActiviteitsRelatedByConfiguredPersoonBriefTemplateId to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	 ...
	 * an identical criteria, it returns the collection.
	 * Otherwise if this BriefTemplate has previously
	 * been saved, it will retrieve related ActiviteitsRelatedByConfiguredPersoonBriefTemplateId from storage.
	 * If this BriefTemplate is new, it will return
	 * an empty collection or the current collection, the criteria
	 * is ignored on a new object.
	 *
	...
	/**
	 * Returns the number of related ActiviteitsRelatedByConfiguredPersoonBriefTemplateId.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      Connection $con
	...
	/**
	 * Temporary storage of collActiviteitsRelatedByConfiguredOrganisatieBriefTemplateId to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	 ...
	 * an identical criteria, it returns the collection.
	 * Otherwise if this BriefTemplate has previously
	 * been saved, it will retrieve related ActiviteitsRelatedByConfiguredOrganisatieBriefTemplateId from storage.
	 * If this BriefTemplate is new, it will return
	 * an empty collection or the current collection, the criteria
	 * is ignored on a new object.
	 *
	...
	/**
	 * Returns the number of related ActiviteitsRelatedByConfiguredOrganisatieBriefTemplateId.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      Connection $con
	...
	/**
	 * Temporary storage of collDossierTypes to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	 ...
	 * an identical criteria, it returns the collection.
	 * Otherwise if this BriefTemplate has previously
	 * been saved, it will retrieve related DossierTypes from storage.
	 * If this BriefTemplate is new, it will return
	 * an empty collection or the current collection, the criteria
	 * is ignored on a new object.
	 *
	...
	/**
	 * Returns the number of related DossierTypes.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      Connection $con
	...
	/**
	 * Method called to associate a DossierType object to this object
	 * through the DossierType foreign key attribute
	 *
	 * @param      DossierType $l DossierType
	 * @return     void
	 * @throws     PropelException
	 */
	 ...
	 * actually need in BriefTemplate.
	 */
	public function getDossierTypesJoinWerkingsjaar($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'lib/model/om/BaseDossierTypePeer.php';
		if ($criteria === null) {
		...
		if ($this->collDossierTypes === null) {
			if ($this->isNew()) {
				...
				$this->collDossierTypes = DossierTypePeer::doSelectJoinWerkingsjaar($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
