...
/**
 * Base class that represents a row from the 'brief_bijlage' table.
 *
 * 
 *
...
abstract class BaseBriefBijlage extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the bijlage_node_id field.
	 * @var        int
	 */
	...
	/**
	 * Get the [bijlage_node_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [bijlage_node_id] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 8; // 8 = BriefBijlagePeer::NUM_COLUMNS - BriefBijlagePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of BriefBijlage (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     BriefBijlage Clone of current object.
	 * @throws     PropelException
	 */
